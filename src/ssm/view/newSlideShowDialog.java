 ...
 * @author Huxton
 */
public class newSlideShowDialog extends Stage {
    ...
    public newSlideShowDialog() {
        ...
        this.setTitle("NEW SlideShow PROMPT");
...
//        languageComboBox.getSelectionModel().select(ENGLISH_LANG);
        ...
        applyButton = new Button("choose file");
...
//        gridPane.add(languageComboBox, 1, 2, 1, 1);
        gridPane.add(new Label("SlideShowSlideMaker"), 1, 4, 1, 1);
