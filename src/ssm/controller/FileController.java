...
import static ssm.LanguagePropertyType.LABEL_SAVE_UNSAVED_WORK;
...
public class FileController {
    ...
    private SlideShowSiteExporter siteExporter;
     ...
     * data.
     */
    public FileController(SlideShowMakerView initUI, 
	...
	try {
	    ...
	    SlideShowModel slideShow = ui.getSlideShow();
	    siteExporter.exportSite(slideShow);
