...
public class Page {
    ...
    public Page(SlideShowMakerView initUI) {

        //Page is just a container for content
        //But this needs to be put in teh context of ssm
        //Create a new Tab
    ...
    public void reset() {
        ...
        footer = props.getProperty(LanguagePropertyType.DEFAULT_SLIDE_SHOW_TITLE);
        selectedSlide = null;
    }
    ...
    /**
     * Removes the currently selected slide from the slide show and updates the
     * display.
     */
    ...
    /**
     * Moves the currently selected slide up in the slide show by one slide.
     */
    ...
    /**
     * Moves the currently selected slide down in the slide show by one slide.
     */
    ...
    /**
     * Changes the currently selected slide to the previous slide in the slide
     * show.
     */
    ...
    /**
     * Changes the currently selected slide to the next slide in the slide show.
     */
    public void next() {
        if (selectedSlide == null) {
            return;
